...
export default function QuizHeader({ title, subjectTitle, current, total, timeLimit, onBack, onTimeUp }) {
  return (
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 pb-6 border-b border-slate-100">
      <div className="flex gap-4 items-center">
        {onBack && (
          <button
            onClick={onBack}
            className="p-3 rounded-2xl bg-white hover:bg-slate-50 text-slate-655 transition-colors border border-slate-205"
          >
