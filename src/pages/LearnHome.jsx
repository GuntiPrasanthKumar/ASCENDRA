...
import { 
  ...
  Code2, Network, ListFilter, Binary, ArrowRight, ShieldCheck, Star
} from 'lucide-react';
        ...
        <div className="w-full space-y-8">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-gradient-to-r from-blue-50/80 via-indigo-50/40 to-blue-50/80 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative overflow-hidden shadow-2xs">
              ...
              {/* Action Button & 3D Soft Graphics */}
          ...
          {/* Your Learning Path / All Subjects */}
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-bold text-slate-900 tracking-tight">Your Learning Path</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredSubjects.map((subj) => (
                <SubjectCard
                  ...
                  lessonsCount={subj.chapterIds?.length || 8}
                  progress={subj.progress || 30}
